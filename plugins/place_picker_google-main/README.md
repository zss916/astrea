...
```dart
"https://maps.googleapis.com/maps/net/place/autocomplete/json?input=${Search-Query}&key=${API-Key}"
```
...
```dart
"https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/net/place/autocomplete/json?input=${Search-Query}&key=${API-Key}"
```

Therefore set the web baseUrl as

```dart
"https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/net/"
```
